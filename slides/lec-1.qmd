...
[https://github.com/Bovi-analytics/BeastsAndBytes](https://bovi-analytics.github.io/BeastsAndBytes/)
...
Update because of genAI:
- Project score (50%) - We will determine the grades for the team project score together (50% of your score)
- Individual score (50%) - Individual coding assignments (%) * Coding exam (%).

Example:

-   Your team project is graded as a group to 20/20 (50%)
-   You individually submitted 80% correct assignments
-   Your coding exam 90% correct assignments
-   Your end score is (50% * 100%) + (50% * 80% * 90%) = 86%
