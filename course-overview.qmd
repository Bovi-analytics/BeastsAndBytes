...
The final scale will be a multiplication from your individual score multiplied with the group project score (we will determine jointly in one of the first lectures how the group project will be graded)
...
a result student A gets 100% * 90% * 100% = 90% as the final individual grade.
...
a result student B gets 50% * 70% * 100% = 35% as the final individual grade.
