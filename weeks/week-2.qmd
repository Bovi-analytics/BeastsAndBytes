...
Part 1: GitHub Education
1. Create a GitHub profile.
2. Create a public repository.
3. Share the repository through Canvas.

Part 2: GitHub and Branching
1. Connect to the assigned repository.
2. Create a branch.
3. Create a merge conflict.
4. Try to merge the branch.
5. Resolve the merge conflict and complete the merge.
