...
To access computing resources for this course we will make use of the [Google Colab](https://colab.research.google.com/) computing services linked to the course drive storage. The link to the Google Drive can be found at [Useful links](https://bovi-analytics.github.io/BeastsAndBytes/course-links.html)

Make sure you get familiar with Google Colab by reading and trying to run your first pieces of code in the '[Welcome To Colaboratory](https://colab.research.google.com/notebooks/basic_features_overview.ipynb)' notebook. We recommend using Colab as it will be easier to work simultaneously with your group mates on the project.
